...
|------|------|-------------|-------|----------|------|
| 2026-04-17 | TextAttack | TextAttack 🐙  is a Python framework for adversarial attacks, data augmentation, and model training in NLP https://textattack.readthedocs.io/en/master/ | ⭐ 3455 | 👁️ 34 | [TextAttack](https://github.com/QData/TextAttack) |
