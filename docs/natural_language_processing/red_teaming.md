...
|------|------|-------------|-------|----------|------|
| 2026-04-17 | TextAttack | TextAttack 🐙  is a Python framework for adversarial attacks, data augmentation, and model training in NLP https://textattack.readthedocs.io/en/master/ | ⭐ 3407 | 👁️ 34 | [TextAttack](https://github.com/QData/TextAttack) |
| 2022-04-19 | OpenAttack | An Open-Source Package for Textual Adversarial Attack. | ⭐ 774 | 👁️ 16 | [OpenAttack](https://github.com/thunlp/OpenAttack) |
