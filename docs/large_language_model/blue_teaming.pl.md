...
|------|------|-------------|-------|----------|------|
| 2026-01-25 | openguardrails | Prevents enterprise AI applications from leaking sensitive data to external LLM providers — without disrupting user workflows. | ⭐ 201 | 👁️ 3 | [openguardrails](https://github.com/openguardrails/openguardrails) |
...
| 2026-01-20 | guardrails | Adding guardrails to large language models. | ⭐ 6310 | 👁️ 34 | [guardrails](https://github.com/guardrails-ai/guardrails) |
