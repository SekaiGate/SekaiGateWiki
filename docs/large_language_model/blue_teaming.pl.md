...
|------|------|-------------|-------|----------|------|
| 2026-03-20 | openguardrails | Security guard for OpenClaw. Protect Agents with real-time defense against prompt injection, data leaks, and dangerous actions. | ⭐ 310 | 👁️ 4 | [openguardrails](https://github.com/openguardrails/openguardrails) |
| 2026-03-18 | guardrails | Adding guardrails to large language models. | ⭐ 6570 | 👁️ 36 | [guardrails](https://github.com/guardrails-ai/guardrails) |
| 2026-03-12 | Guardrails | NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems. | ⭐ 5834 | 👁️ 41 | [Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) |
| 2026-03-11 | PurpleLlama | Set of tools to assess and improve LLM security. | ⭐ 4080 | 👁️ 67 | [PurpleLlama](https://github.com/meta-llama/PurpleLlama) |
| 2025-12-11 | alibi-detect | Algorithms for outlier, adversarial and drift detection | ⭐ 2505 | 👁️ 35 | [alibi-detect](https://github.com/SeldonIO/alibi-detect) |
| 2025-10-08 | granite-guardian | The Granite Guardian models are designed to detect risks in prompts and responses. | ⭐ 136 | 👁️ 9 | [granite-guardian](https://github.com/ibm-granite/granite-guardian) |
| 2025-09-03 | llm-guard | The Security Toolkit for LLM Interactions | ⭐ 2715 | 👁️ 26 | [llm-guard](https://github.com/protectai/llm-guard) |
...
| 2024-11-22 | langkit | 🔍 LangKit: An open-source toolkit for monitoring Large Language Models (LLMs). 📚 Extracts signals from prompts & responses, ensuring safety & security. 🛡️ Features include text quality, relevance metrics, & sentiment analysis. 📊 A comprehensive tool for LLM observability. 👀 | ⭐ 979 | 👁️ 15 | [langkit](https://github.com/whylabs/langkit) |
| 2024-11-22 | langkit | 🔍 LangKit: An open-source toolkit for monitoring Large Language Models (LLMs). 📚 Extracts signals from prompts & responses, ensuring safety & security. 🛡️ Features include text quality, relevance metrics, & sentiment analysis. 📊 A comprehensive tool for LLM observability. 👀 | ⭐ 979 | 👁️ 15 | [langkit](https://github.com/whylabs/langkit) |
| 2024-07-16 | HeimdaLLM | Constrain LLM output | ⭐ 113 | 👁️ 3 | [HeimdaLLM](https://github.com/amoffat/HeimdaLLM) |
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 467 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 467 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
| 2024-01-25 | rebuff | LLM Prompt Injection Detector | ⭐ 1450 | 👁️ 15 | [rebuff](https://github.com/protectai/rebuff) |
| 2024-01-25 | rebuff | LLM Prompt Injection Detector | ⭐ 1450 | 👁️ 15 | [rebuff](https://github.com/protectai/rebuff) |
