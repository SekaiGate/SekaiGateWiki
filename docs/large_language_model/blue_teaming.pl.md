...
|------|------|-------------|-------|----------|------|
| 2026-02-04 | Guardrails | NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems. | ⭐ 5604 | 👁️ 39 | [Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) |
| 2026-02-03 | openguardrails | Prevents enterprise AI applications from leaking sensitive data to external LLM providers — without disrupting user workflows. | ⭐ 218 | 👁️ 3 | [openguardrails](https://github.com/openguardrails/openguardrails) |
...
| 2026-01-20 | guardrails | Adding guardrails to large language models. | ⭐ 6363 | 👁️ 38 | [guardrails](https://github.com/guardrails-ai/guardrails) |
...
| 2025-09-03 | llm-guard | The Security Toolkit for LLM Interactions | ⭐ 2497 | 👁️ 24 | [llm-guard](https://github.com/protectai/llm-guard) |
...
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 451 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 451 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
