...
|------|------|-------------|-------|----------|------|
| 2026-03-06 | guardrails | Adding guardrails to large language models. | ⭐ 6500 | 👁️ 36 | [guardrails](https://github.com/guardrails-ai/guardrails) |
| 2026-03-06 | Guardrails | NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems. | ⭐ 5734 | 👁️ 40 | [Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) |
| 2026-03-05 | openguardrails | #1 OpenClaw security plugin — protect your OpenClaw with real-time defense against prompt injection, data leaks, and dangerous actions. | ⭐ 271 | 👁️ 3 | [openguardrails](https://github.com/openguardrails/openguardrails) |
| 2026-02-19 | PurpleLlama | Set of tools to assess and improve LLM security. | ⭐ 4052 | 👁️ 66 | [PurpleLlama](https://github.com/meta-llama/PurpleLlama) |
| 2025-12-11 | alibi-detect | Algorithms for outlier, adversarial and drift detection | ⭐ 2496 | 👁️ 35 | [alibi-detect](https://github.com/SeldonIO/alibi-detect) |
...
| 2025-09-03 | llm-guard | The Security Toolkit for LLM Interactions | ⭐ 2622 | 👁️ 26 | [llm-guard](https://github.com/protectai/llm-guard) |
