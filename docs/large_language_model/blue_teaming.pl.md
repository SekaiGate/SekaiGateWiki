...
## Wprowadzenie
Ta strona została stworzona dla członków niebieskiej drużyny, badaczy sztucznej inteligencji oraz entuzjastów defensywnej strony bezpieczeństwa LLM.
Znajdziesz tu narzędzia, zasoby i uwagi dotyczące ochrony dużych modeli językowych (LLM).
...
|------|------|-------------|-------|----------|------|
| 2026-09-02 | Guardrails | NeMo Guardrails is an open-source toolkit for easily adding programmable guardrails to LLM-based conversational systems. | ⭐ 7064 | 👁️ 43 | [Guardrails](https://github.com/NVIDIA-NeMo/Guardrails) |
| 2026-08-30 | openguardrails | The vendor-neutral protocol for AI agent safety & security — and the neutral benchmark that ranks the vendors. | ⭐ 35 | 👁️ 0 | [openguardrails](https://github.com/openguardrails/openguardrails) |
| 2026-08-26 | guardrails | Adding guardrails to large language models. | ⭐ 7354 | 👁️ 41 | [guardrails](https://github.com/guardrails-ai/guardrails) |
| 2026-08-26 | granite-guardian | The Granite Guardian models are designed to detect risks in prompts and responses. | ⭐ 174 | 👁️ 9 | [granite-guardian](https://github.com/ibm-granite/granite-guardian) |
| 2026-08-18 | PurpleLlama | Set of tools to assess and improve LLM security. | ⭐ 4380 | 👁️ 67 | [PurpleLlama](https://github.com/meta-llama/PurpleLlama) |
| 2026-07-08 | llm-guard | The Security Toolkit for LLM Interactions | ⭐ 3204 | 👁️ 29 | [llm-guard](https://github.com/protectai/llm-guard) |
| 2025-12-11 | alibi-detect | Algorithms for outlier, adversarial and drift detection | ⭐ 2548 | 👁️ 36 | [alibi-detect](https://github.com/SeldonIO/alibi-detect) |
...
| 2024-11-22 | langkit | 🔍 LangKit: An open-source toolkit for monitoring Large Language Models (LLMs). 📚 Extracts signals from prompts & responses, ensuring safety & security. 🛡️ Features include text quality, relevance metrics, & sentiment analysis. 📊 A comprehensive tool for LLM observability. 👀 | ⭐ 996 | 👁️ 19 | [langkit](https://github.com/whylabs/langkit) |
| 2024-11-22 | langkit | 🔍 LangKit: An open-source toolkit for monitoring Large Language Models (LLMs). 📚 Extracts signals from prompts & responses, ensuring safety & security. 🛡️ Features include text quality, relevance metrics, & sentiment analysis. 📊 A comprehensive tool for LLM observability. 👀 | ⭐ 996 | 👁️ 19 | [langkit](https://github.com/whylabs/langkit) |
| 2024-07-16 | HeimdaLLM | Constrain LLM output | ⭐ 115 | 👁️ 3 | [HeimdaLLM](https://github.com/amoffat/HeimdaLLM) |
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 496 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
| 2024-01-31 | vigil-llm | ⚡ Vigil ⚡  Detect prompt injections, jailbreaks, and other potentially risky Large Language Model (LLM) inputs | ⭐ 496 | 👁️ 9 | [vigil-llm](https://github.com/deadbits/vigil-llm) |
| 2024-01-25 | rebuff | LLM Prompt Injection Detector | ⭐ 1521 | 👁️ 2 | [rebuff](https://github.com/protectai/rebuff) |
| 2024-01-25 | rebuff | LLM Prompt Injection Detector | ⭐ 1521 | 👁️ 2 | [rebuff](https://github.com/protectai/rebuff) |
...
| Date | Repo | Description | Stars | Watchers | Link |
|------|------|-------------|-------|----------|------|
| 2026-03-25 | LangBiTe | A Bias Tester framework for LLMs | ⭐ 26 | 👁️ 3 | [LangBiTe](https://github.com/SOM-Research/LangBiTe) |
| 2024-08-12 | anonLLM | anonLLM: Anonymize Personally Identifiable Information (PII) for Large Language Model APIs | ⭐ 80 | 👁️ 1 | [anonLLM](https://github.com/fsndzomga/anonLLM) |
<!-- END_DATA_LARGE_LANGUAGE_MODEL_BLUE_TEAMING_PRIVACY_SOURCES -->
