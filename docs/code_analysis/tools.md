...
| 2026-02-11 | claude-code-security-review | An AI-powered security review GitHub Action using Claude to analyze code changes for security vulnerabilities. | ⭐ 6172 | 👁️ 40 | [claude-code-security-review](https://github.com/anthropics/claude-code-security-review) |
...
| 2025-02-06 | vulnhuntr | Zero shot vulnerability discovery using LLMs | ⭐ 2761 | 👁️ 33 | [vulnhuntr](https://github.com/protectai/vulnhuntr) |
